    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Carrera")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=255, verbose_name="Clasificación"),
                ),
            ],
            options={
                "verbose_name": "Clasificación",
                "verbose_name_plural": "Clasificacións",
            },
        ),
        migrations.CreateModel(
            name="Collection",
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Colección")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Facultad")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Formato")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Licencia")),
                (
                    "image",
                    models.ImageField(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Fuente")),
            ],
            options={
                "verbose_name": "Fuente",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Asignatura")),
                (
                    "career",
                    models.ManyToManyField(to="library.career", verbose_name="Carrera"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Tema")),
                (
                    "subject",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="Escuela")),
                (
                    "faculty",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "international_id",
                    models.CharField(
                        max_length=255, unique=True, verbose_name="ID Internacional"
                    ),
                ),
                ...
                (
                    "edition",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="Edición"
                    ),
                ),
                ("publish_date", models.DateField(verbose_name="Fecha de Publicación")),
                (
                    "coverage_start",
                    models.DateField(verbose_name="Fecha de Inicio de Cobertura"),
                ),
                (
                    "coverage_end",
                    models.DateField(verbose_name="Fecha de Fin de Cobertura"),
                ),
                ("abstract", models.TextField(verbose_name="Resumen")),
                (
                    "extension",
                    models.CharField(max_length=255, verbose_name="Extensión"),
                ),
                (
                    "language",
                    apps.languages.fields.LanguageField(
                        choices=[
                            ("aa", "Afar"),
                            ("ab", "Abkhazian"),
                            ("ae", "Avestan"),
                ...
                (
                    "author",
                    models.ManyToManyField(to="library.author", verbose_name="Autor"),
                ),
                (
                    "career",
                    models.ManyToManyField(to="library.career", verbose_name="Carrera"),
                ...
                (
                    ...
                    models.ManyToManyField(
                        to="library.faculty", verbose_name="Facultad"
                    ),
                ),
                (
                    "format",
                    models.ManyToManyField(to="library.format", verbose_name="Formato"),
                ),
                (
                    "license",
                    models.ForeignKey(
                ...
                (
                    "school",
                    models.ManyToManyField(to="library.school", verbose_name="Escuela"),
                ),
                (
                    "source",
                    models.ForeignKey(
                ...
                (
                    "subject",
                    models.ManyToManyField(
                        to="library.subject", verbose_name="Asignatura"
                    ),
                ),
                (
                    "theme",
                    models.ManyToManyField(to="library.theme", verbose_name="Tema"),
                ),
            ],
            options={
